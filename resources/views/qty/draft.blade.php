...
<body>
    ...
    <div class="btn-container mt-4">
        ...
        <a href="/konfir" style="text-decoration: none;">
            <b>BELI TIKET</b>
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#fcfcfc" viewBox="0 0 256 256">
                <path
                    d="M237.66,133.66l-96,96A8,8,0,0,1,128,224V184H48a16,16,0,0,1-16-16V88A16,16,0,0,1,48,72h80V32a8,8,0,0,1,13.66-5.66l96,96A8,8,0,0,1,237.66,133.66Z">
...
<body>
    ...
    <div class="container mt-5">
        <div class="angka">
            ...
            <button class="clear-btn" onclick="deleteLastCharacter()">←</button>
        </div>
    </div>
    ...
    <div class="btn-container mt-4">
        ...
        <form action="{{ route('qty.confirm') }}" method="POST" id="quantity-form" onsubmit="return validateQuantity()">
            @csrf
            <input type="hidden" name="quantity" id="hidden-quantity">
            <button type="submit" style="text-decoration: none;" id="buy-ticket-btn" class="disabled">
                <b>BELI TIKET</b>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#fcfcfc" viewBox="0 0 256 256">
    ...
    <script>
        ...
        function toggleButton() {
            ...
            buyTicketBtn.classList.toggle('disabled', quantityValue <= 0);
        }
