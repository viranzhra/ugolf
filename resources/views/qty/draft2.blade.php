...
<body>
    ...
    @endif
    <form action="{{ route('process_ticket_purchase') }}" method="POST">
        @csrf
        <input type="number" name="qty" id="formQty" style="display:none" min="1" value="1" required>
        <button id="pushSubmit" type="submit" style="display:none">Bayar</button>
    </form>
        ...
        <div class="input-container">
            <div class="quantity-control-wrapper">
                ...
                <input type="number" id="quantity-input" class="form-control text-center" readonly
                    required placeholder="Jumlah" oninput="toggleButton()">
        ...
        <div class="btn-container mt-4">
            ...
            <a href="#" style="text-decoration: none;" id="buy-ticket-btn" class="disabled"
                onclick="document.getElementById('pushSubmit').click(); return false;">
                <b>BELI TIKET</b>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#fcfcfc"
                    viewBox="0 0 256 256">
                    <path
    ...
    <script>
        ...
        function updateFormQty(value) {
            document.getElementById('formQty').value = value || 0;
        }
        ...
        function appendNumber(number) {
            ...
            updateFormQty(quantityInput.value);
            toggleButton();
        }
